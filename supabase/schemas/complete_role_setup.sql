-- Complete the role system setup
-- Run this after fixing the user role constraint
...
BEGIN
  ...
  IF new.email IN ('super@dsr.com', 'owner@dsr.com', 'saleem@poppatjamals.com') THEN
...
SELECT 'Role system setup completed successfully!' as status;
SELECT 'Your email has been added as super_user role' as user_status;